...
For the final part of class, let's look at how to do the assignment using Latex and github. Navigate to the `tutorial02` directory on your computer. If you have not already done so, you will need to install [TexStudio](https://www.texstudio.org/).