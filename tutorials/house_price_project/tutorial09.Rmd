...
We can see by comparing the two models that the effect of `Rank_Code` is perhaps not best modelled as a constant. Let's visualise this new model to see the difference intuitively.
...
Compare the below plot with our first scatter plot.
