...
\begin{enumerate} 
	...
	\begin{enumerate}
		...
		\begin{verbatim}
			...
			[1]  93.96 102.92
		\end{verbatim}
		The confidence interval is then computed and rounded to 2 decmimal places, which provides the results of 93.96 for the lower bound and 102.92 for the upper bound of the 90\% confidence interval.
